...
// 24-hour band with four quiet lanes: feed dots (filled = bottle, hollow =
// nursing), diaper ticks, sleep spans and growth/health diamonds. The sleep
// lane is sourced from minutesOnDay overlap — never isSameDay on startedAt —
// so an overnight 23:00→06:00 sleep renders on both days it touches.
  ...
  return (
    ...
    >
      <div className="day-band-lanes">
        ...
        {isToday && <span className="band-now" style={{ left: `${pct(now)}%` }} />}
      </div>
